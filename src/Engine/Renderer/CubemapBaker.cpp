...

{
    ...
    TextureDesc cubeDesc = TextureDesc::MakeExplicit(faceSize, faceSize, 3, GL_RGB16F, GL_RGB, GL_FLOAT, srgb);
...
{
    TextureDesc desc = TextureDesc::MakeExplicit(kBrdfLutSize, kBrdfLutSize, 2, GL_RG16F, GL_RG, GL_FLOAT);
